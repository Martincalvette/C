...
/** \brief strcpy(pBuffer[indice].direccion,direccion);  devuelve un numero de Id que no se repite.
 ...
 * \return int Return comienza en 0 si esta todo bien y -1 si algun parametro es incorrecto
 */
cli_alta(Cliente* pBuffer,int id,int limite,char* direccion,char* localidad,char* nombre,char*cuit);
